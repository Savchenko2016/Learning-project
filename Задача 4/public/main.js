...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.showRequests = function () {
	  ...
	  for (var id in localStorage) {
	    try {
	      ...
	      if (object.login() !== undefined && object.type() == 'Клиент') customersId.push(id);
	    } catch (err) {}
	  }
	...
	exports.showRequestDetails = function (id) {
	  ...
	  var div = tmpl({
	    ...
	    items: items,
	    table: [exports.request.customerId(), exports.request.performerId(), exports.request.summary(), exports.request.priority(), exports.request.estimated(), exports.request.created(), exports.request.deadline(), exports.request.ready() + '%', exports.request.status()]
	  });
	  $(document.body).append(div);
	...
	exports.recordRequest = function (e) {
	  ...
	  var deadline = new Date($(document.body).find('.years').prop('value'), functions.months.indexOf($(document.body).find('.months').prop('value')), $(document.body).find('.days').prop('value'), $(document.body).find('input[name="hours"]').prop('value'), $(document.body).find('input[name="minutes"]').prop('value'), $(document.body).find('input[name="seconds"]').prop('value')).toLocaleString('ru', exports.options);
	...
	exports.submitRequest = function (e) {
	  ...
	  if (exports.user.type() === 'Администратор') {
	    ...
	    var deadline = new Date($(document.body).find('.years').prop('value'), $(document.body).find('.months').prop('value'), $(document.body).find('.days').prop('value'), $(document.body).find('input[name="hours"]').prop('value'), $(document.body).find('input[name="minutes"]').prop('value'), $(document.body).find('input[name="seconds"]').prop('value')).toLocaleString('ru', exports.options);
