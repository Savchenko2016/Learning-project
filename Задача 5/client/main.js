...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.showAuthoristation = function () {
	  ...
	  $('#reg-customer').one('click', function () {
	    functions.hide();
	    var tmpl = __webpack_require__(10);
	    var div = tmpl({});
	    $(document.body).append(div);
	    ...
	    $.ajax({
	      ...
	      success: function (data, status, jqxhr) {
	        ...
	        $('.pager li').each(function (index, elem) {
	          if (index + 1 == index1) $(elem).addClass('active');
	        });
	  ...
	  $.ajax({
	    ...
	    success: function (data, status, jqxhr) {
	      ...
	      var div = tmpl({
	        ...
	        items: items,
	        table: [exports.request.customerId(), exports.request.performerId(), exports.request.summary(), exports.request.priority(), exports.request.estimated(), new Date(exports.request.created()).toLocaleString('ru', exports.options), new Date(exports.request.deadline()).toLocaleString('ru', exports.options), exports.request.ready() + '%', exports.request.status()]
	      });
	      $(document.body).append(div);
	
	      $('#list-requests').one('click', function () {
	        exports.showRequests();
	      });
	
	      $('#add-comment').one('click', function () {
	        functions.hide();
	        var tmpl = __webpack_require__(15);
	...
	exports.createRequest = function (e) {
	  ...
	  var render = function (jqxhr, status) {
	    var tmpl = __webpack_require__(16);
	    var div = tmpl({
	...
	exports.recordRequest = function (e) {
	  ...
	  var deadline = new Date($(document.body).find('.years').prop('value'), functions.months.indexOf($(document.body).find('.months').prop('value')), $(document.body).find('.days').prop('value'), $(document.body).find('input[name="hours"]').prop('value'), $(document.body).find('input[name="minutes"]').prop('value'), $(document.body).find('input[name="seconds"]').prop('value'));
	...
	exports.filterCustomer = function () {
	  ...
	  if (customer === 'Любой') delete filter.customerId;else filter.customerId = customer;
	  offset = 0;
	...
	exports.filterStatus = function () {
	  ...
	  delete filter.summary;
	  if (status === 'Любой') delete filter.status;else filter.status = status;
	  offset = 0;
	  exports.filterRequests('created', filter);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.VALIDATE_ARR = [/^[а-яА-ЯёЁa-zA-Z0-9\s.?"',:;%@!()]+$/, //простой текст
	/^[a-zA-Z][a-zA-Z0-9-_\.]{2,20}$/, //логин
	/^([a-zA-Z0-9_-]+\.)*[a-zA-Z0-9_-]+@[a-z0-9_-]+(\.[a-z0-9_-]+)*\.[a-z]{2,6}$/, //email
	/^[a-zA-Z][a-zA-Z0-9-_\.]{4,20}$/, //пароль
	/^[1-9][0-9]+$/ //int
	];
	
	exports.validate = function (content, type) {
	  if (type == 4) return exports.isNumeric(content);
	...
	exports.User = function () {
	  ...
	  var type;
	  var requestsId = [];
	  var TYPE_ARR = ['performer', 'customer', 'admin'];
	  ...
	  this.requestsId = function (value) {
	    if (!arguments.length) return requestsId;
	    requestsId = value;
	  };
	  ...
	  this.login = function (userLogin) {
	    ...
	    if (exports.validate(userLogin, 1)) login = userLogin;
	  };
	
	  this.email = function (userEmail) {
	    if (!arguments.length) return email;
	
	    if (exports.validate(userEmail, 2)) email = userEmail;
	  };
	
	  this.password = function (userPassword) {
	    if (!arguments.length) return password;
	
	    if (exports.validate(userPassword, 3)) password = userPassword;
	  };
	...
	exports.Comment = function () {
	  ...
	  this.text = function (commentText) {
	    ...
	    if (exports.validate(commentText, 0)) text = commentText;
	  };
	...
	exports.Request = function () {
	  ...
	  this.commentsId = function (value) {
	    if (!arguments.length) return commentsId;
	  ...
	  this.description = function (requestDescription) {
	    ...
	    if (exports.validate(requestDescription, 0)) description = requestDescription;
	  };
	
	  this.summary = function (requestSummary) {
	    if (!arguments.length) return summary;
	
	    if (exports.validate(requestSummary, 0)) summary = requestSummary;
	  };
	  ...
	  this.status = function (requestStatus) {
	    ...
	    if (STATUS_ARR.indexOf(requestStatus) != -1) status = requestStatus;
	  };
	
	  this.estimated = function (requestEstimated) {
	    if (!arguments.length) return estimated;
	
	    if (exports.isNumeric(requestEstimated) && requestEstimated >= 0) estimated = requestEstimated;
	  };
	  ...
	  this.ready = function (requestReady) {
	    ...
	    if (exports.isNumeric(requestReady) && requestReady >= 0 && requestReady <= 100) ready = requestReady;
	  };
	};
	...
	exports.init = function (object, name) {
	  if (typeof object !== 'object') return null;
	  object.name = object.name === undefined ? name : object.name;
	  var result = eval('new exports.' + object.name + '();');
	  delete object.name;
	  for (var i in object) {
	    if (result.attrs.indexOf(i) !== -1) result[i](object[i]);
	  }
	  return result;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(true){// Define as an anonymous module so, through path mapping, it can be
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.displayError = function (text, f) {
	  ...
	  $('body').append(error);
	  if (f === 'undefined' || f === false) return error;
	  setTimeout(function () {
	    $('.error').remove();
	  }, 2000);
	  return error;
...
/***/ function(module, exports) {
	...
	var __t, __p = '';
	with (obj) {
	__p += '<div id="client_registration">\n  <section class="form">\n    <h3>Регистрация клиента</h3>\n    <form novalidate>\n      <fieldset class="clearfix">\n				<p><input type="text" placeholder="Логин" name="login" required></p>\n				<p><input type="email" placeholder="E-mail" name="email" required></p>\n				<p><input type="password" placeholder="Пароль" name="password" required></p>\n				<p><input type="submit" value="ВОЙТИ" class="button"></p>\n      </fieldset>\n    </form>\n  </section>\n</div>\n \n';
...
/***/ function(module, exports) {
	...
	function print() { __p += __j.call(arguments, '') }
	with (obj) {
	__p += '<div class="table-pager">\n<table>\n  <tr><th temp="customerId">Клиент</th><th temp="performerId">Исполнитель</th><th temp="summary">Название</th><th temp="priority">Приоритет</th><th temp="estimated">Предполагаемое время выполнения</th><th temp="deadline">Deadline</th><th temp="ready">Готовность</th><th temp="status">Статус</th></tr>\n  ';
	 if (items.length === 0) { ;
	...
	__e(items[i].id ) +
	'</td><td>' +
	__e(items[i].customerId ) +
	'</td><td>' +
	__e(items[i].performerId ) +
	'</td><td>' +
	__e(items[i].summary ) +
	'</td><td>' +
	__e(items[i].priority ) +
	'</td><td>' +
	__e(items[i].estimated ) +
	'</td><td>' +
	__e(items[i].deadline ) +
	'</td><td>' +
	__e(items[i].ready + '%' ) +
	'</td><td>' +
	__e(items[i].status ) +
...
/***/ function(module, exports) {
	...
	function print() { __p += __j.call(arguments, '') }
	with (obj) {
	__p += '<div id="list_request">\n  <header class="clearfix">\n    <h3>Список заявок</h3>\n    ';
	 if (f1) { ;
	__p += '\n    <a href="#" class="button" id="create-request">Создать заявку</a>\n    ';
	 } ;
	__p += '\n    <a href="#" class="button" id="back-authorisation">Выйти</a>\n    ';
	 if (f3) { ;
	__p += '\n    <a href="#" class="button" id="create-performer">Создать исполнителя</a>\n    ';
	 } ;
	__p += '\n    <div class="user-info">\n      <p>Приветствуем вас, <span>' +
	__e(login ) +
	'</span> </p>\n    </div>\n  </header>\n  <section class="search">\n    <form novalidate>\n      <input type="text" placeholder="Введите название заявки" required>\n      <input type="submit" value="Найти">\n    </form>\n  </section>\n  <section class="filter">\n    <form>\n      ';
	 if (f2) { ;
...
/***/ function(module, exports) {
	...
	function print() { __p += __j.call(arguments, '') }
	with (obj) {
	__p += '<div id="request_details">\n  <header class="clearfix">\n    <h3>Информация о заявке <span>' +
	__e(id ) +
	'</span></h3>\n    \n    <a href="#" class="button" id="list-requests">Список заявок</a>\n    <a href="#" class="button" id="add-comment">Добавить комментарий</a>\n    ';
	 if (f) { ;
	__p += '\n    <a href="#" class="button" id="edit-request">Редактировать заявку</a>\n    ';
	 } ;
	__p += '\n    <div class="user-info">\n      <p>Приветствуем вас, <span class="user">' +
	__e(login ) +
	'<span> </p>\n    </div>\n  </header>\n  <section class="request-detail">\n    <table>\n      <tr><th>Клиент</th><th>Исполнитель</th><th>Название</th><th>Приоритет</th><th>Предполагаемое время выполнения</th><th>Дата открытия</th><th>Deadline</th><th>Готовность</th><th>Статус</th></tr>\n      <tr>\n      ';
	...
	'\n      </div>\n    </article>\n    <article>\n      <div class="content" id=\'comments\'>\n	';
	 if (items.length === 0) { ;
	__p += '\n	<h3>Комментариев еще нет.</h3>\n	';
	 } else { ;
	__p += '\n        <h3>Комментарии:</h3>\n	  ';
	 for (var i = 0; i < items.length; i++) { ;
	__p += '\n	  <ul>\n	    <li>' +
	__e(items[i].date + ' - ' + items[i].type + ' [' + items[i].userId + ']' ) +
	'</li>\n	    <li>' +
	__e(items[i].text ) +
	'</li>\n	  </ul>\n	  ';
	 } } ;
...
/***/ function(module, exports) {
	...
	__p += '\n	      <option>Closed</option>\n	    </select>\n	  </label>\n	  <p><textarea name="text" rows="10" required placeholder="Текст комментария"></textarea></p>\n	  <p><input type="submit" value="СОЗДАТЬ" class="button"></p>\n	</fieldset>\n      </form>\n    </section>\n</div> \n';
...
/***/ function(module, exports) {
	...
	function print() { __p += __j.call(arguments, '') }
	with (obj) {
	__p += '<div id="create_request">\n  <section class="form create-request">\n    <h3>Создание новой заявки</h3>\n    <form action="javascript:void(0);" method="get" novalidate>\n      <fieldset class="clearfix">\n	<label>Исполнитель<br>\n	  <select name="performer" required>\n	  ';
	 for (var i = 0; i<performers.length; ++i) { ;
	__p += '\n	    <option value="' +
	__e(performers[i].id ) +
	'">\n        ' +
	__e(performers[i].username ) +
	'\n	    </option>\n	  ';
	 } ;
	__p += '\n	  </select>\n	</label>\n	<p><input type="text" name="summary" placeholder="Заголовок" required></p>\n	<p>\n	  <textarea name="description" rows="5" required placeholder="Описание"></textarea>\n	</p>\n	<label>Приоритет<br>\n	  <select name="priority" required>\n	    <option>LOW</option>\n	    <option>MEDIUM</option>\n	    <option>HIGH</option>\n	  </select>\n	</label>\n	<label>Приблизительное время выполнения<br>\n	  <input type="text" name="estimated" palceholder="0" required>\n	</label>\n	<label class="date">Deadline<br>\n	  <select class = "days" name="days">\n	  ';
	 for (var key in days) { ;
	__p += '\n	    <option>\n              ' +
	__e(days[key] ) +
	'\n	    </option>\n	  ';
...
/***/ function(module, exports) {
	...
	__e(items[i].id ) +
	'">\n              ' +
	__e(items[i].username ) +
	'\n	    </option>\n	    ';
	 } ;
	__p += '\n	    </select>\n	  </label>\n	  <label>Приблизительное время выполнения<br>\n	    <input type="text" name="estimated" placeholder="0" required>\n	  </label>\n	  <label class="date">Deadline<br>\n	    <select class = "days" name="days">\n	  ';
	 for (var key in days) { ;
	__p += '\n	    <option>\n              ' +
	__e(days[key] ) +
	'\n	    </option>\n	  ';
	...
	__p += '\n			<div id="performer-edit">\n        <label>Готовность<br />\n          <input type="number" name="ready" min="0" max="100" />\n        </label>\n        <label>Статус<br />\n        <select name="status">\n	      <option>Открыто</option>\n	      <option>Переоткрыто</option>\n	      <option>Проверка</option>\n	      <option>Закрыто</option>\n	    </select>\n          </label>\n        </div>\n	<p><input type="submit" value="ИЗМЕНИТЬ" class="button"></p>\n      </fieldset>\n    </form>\n  </section>\n</div> \n';
...
/***/ function(module, exports, __webpack_require__) {
	...
	// imports
	exports.push([module.id, "@import url(http://meyerweb.com/eric/tools/css/reset/reset.css);", ""]);
	
	// module
	exports.push([module.id, "@charset \"utf-8\";\n\nbody {\n  background-color: #2c3338;\n  width: 1200px;\n  margin: 0 auto !important;\n}\n\ninput:not([name=\"datetime-local\"]), textarea {\n  border: none;\n  padding: 0;\n  appearance: none;\n  -moz-appearance: none;\n  -webkit-appearance: none;\n}\n\n.clearfix:before, .clearfix:after {\n  display: table;\n  content: \"\";\n}\n.clearfix:after { clear: both; }\n\n.form {\n  margin: 150px auto;\n  width: 280px;\n}\n\n.create-request {\n  margin: 50px auto;\n  width: 400px;\n}\n\n.form form input:not([name=\"datetime-local\"]) {\n  height: 50px;\n  outline:none;\n}\n\n.form form input[type=\"text\"], .form form input[type=\"password\"], .form form input[type=\"email\"], .form form textarea {\n  background-color: #3b4148;\n  border-radius: 0px 3px 3px 0px;\n  -moz-border-radius: 0px 3px 3px 0px;\n  -webkit-border-radius: 0px 3px 3px 0px;\n  margin-bottom: 1em;\n  padding: 0 16px;\n  width: 248px;\n}\n\n.form form input[type=\"number\"] {\n  background-color: #3b4148;\n  padding-left: 16px;\n  border-radius: 0px 3px 3px 0px;\n  -moz-border-radius: 0px 3px 3px 0px;\n  -webkit-border-radius: 0px 3px 3px 0px;\n  margin-bottom: 1em;\n  width: 264px;\n}\n\n.form form textarea {\n  outline: none;\n  padding: 16px;\n  resize: none;\n  overflow: hidden;\n}\n\n.form form select, .filter form select {\n  background-color: #3b4148;\n  border-radius: 0px 3px 3px 0px;\n  -moz-border-radius: 0px 3px 3px 0px;\n  -webkit-border-radius: 0px 3px 3px 0px;\n  margin: 1em 0;\n  width: 280px;\n  height: 40px;\n  outline:none;\n  border: none;\n  padding-left: 16px;\n}\n\n.button {\n  border-radius: 3px;\n  -moz-border-radius: 3px;\n  -webkit-border-radius: 3px;\n  background-color: #ea4c88;\n  margin-bottom: 2em;\n  cursor:pointer;\n  padding: 16px;\n  width: 248px;\n  display: block;\n}\n\n.form form input[type=\"submit\"] {\n  width: 280px;\n}\n\n.button:hover {\n  background-color: #d44179;\n}\n\nh3 {\n  padding: 16px;\n}\n\n.form form label {\n  display: block;\n  width: 280px;\n}\n\n.form .left {\n  float: left;\n}\n\n.form .right {\n  float: right;\n}\n\n.create-request form input, .create-request form select, .create-request form label {\n  width: 400px;\n}\n\n.create-request form input[type=\"text\"], .create-request form textarea {\n  width: 368px;\n  box-sizing: content-box;\n}\n\n.create-request form input {\n  display: block;\n  margin: 0 auto;\n}\n\n.create-request form input[type=\"number\"] {\n  width: 384px;\n}\n\nform label.date > select {\n  width: auto !important;\n  margin-left: 10px;\n}\n\nform label.date .days {\n  margin-left: 0px !important;\n}\n\nheader h3 {\n  float: left;\n  display: block;\n  margin: 0 16px;\n}\n\nheader .user-info {\n  float: right;\n  margin: 0 16px;\n}\n\nheader .user-info > * {\n  display: inline-block;\n}\n\nheader .button {\n  margin: 0;\n  float: left;\n  width: auto !important;\n  padding: 16px;\n  background:  #3b4148;\n  border-radius: 0px;\n}\n\ntable {\n  width: 100%;\n}\n\ntr {\n  cursor: pointer;\n}\n\ntable th {\n  background-color: #ea4c88;\n}\n\ntable td, table th {\n  border: 1px solid #3b4148;\n  text-align: center;\n}\n\n.request-detail {\n  width: 1000px;\n  margin: 20px auto;\n}\n\narticle .content {\n  width: 1000px;\n  border-radius: 3px;\n  -moz-border-radius: 3px;\n  -webkit-border-radius: 3px;\n  background-color: #3b4148;\n}\n\n\narticle.first .content {\n  width: 960px;\n  padding: 20px;\n}\n\narticle:not(:first-child) {\n  margin-top: 20px;\n}\n\narticle h3 {\n  padding: 20px;\n}\n\narticle .content ul li:first-child {\n  background-color: #ea4c88;\n}\n\narticle .content ul li {\n  padding: 15px 20px;\n}\n\n.error {\n  padding: 20px;\n  margin: 5px auto;\n  background-color: #3b4148;\n  width: 200px;\n}\n\n.col {\n  float:left;\n  width: 130px!important;\n}\n\n.col input {\n  width: 110px!important;\n}\n\n.col:not(:first-child) {\n  padding-left: 5px;\n}\n\n.search form input {\n  display: inline-block;\n  margin-bottom: 50px;\n}\n\n.search form input[type=\"submit\"] {\n  background-color: #ea4c88;\n  cursor:pointer;\n  padding: 16px;\n  height: 50px;\n  outline: none;\n}\n\n.search form input:first-child {\n  height: 50px;\n  outline: none;\n  background-color: #3b4148;\n  padding-left: 16px;\n  width: 400px;\n}\n\n.filter {\n  float: right;\n}\n\n.filter form select {\n  display: inline-block;\n  padding-left: 10px;\n}\n\nsection.search, section.filter {\n  display: inline-block;\n}\n\n.pager {\n  height: 20px;\n}\n\n.pager li {\n  float: left;\n  display: inline-block;\n  width: 30px;\n  height: 30px;\n  padding-right: 1px;\n  background-color: #ea4c88;\n}\n\n.pager li:not(.active) {\n  cursor: pointer;\n  background:  #3b4148;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./typography.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./typography.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
