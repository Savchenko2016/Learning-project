...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {var events = __webpack_require__(2);
	...
	$(document).ready(function (e) {
	  $('body').append(__webpack_require__(17));
	  ...
	  $('#add-comment').click(function () {
	    ...
	    var value;
	    if (events.user.type() === 'Исполнитель') value = 'none';else value = 'auto';
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {var exports = module.exports = {};
	...
	exports.showRequestDetails = function (id) {
	  ...
	  if (exports.user.type() === 'Клиент') $('#edit-request').css('display', 'none');else $('#edit-request').css('display', 'block');

	  var table = functions.request_details.find('table');
	  functions.removeElements(table, 'tr', 1);
	  tr = $('<tr></tr>');
	  functions.createSimpleElement(tr, 'td', exports.request.customerId(), exports.request.performerId(), exports.request.summary(), exports.request.priority(), exports.request.estimated(), exports.request.created(), exports.request.deadline(), exports.request.ready() + '%');
	  table.append(tr);
	  ...
	  comments.html('');
	  if (commentsId.length === 0) comments.html('<h3>Комментариев еще нет.</h3>');else {
	    var items = [];
	...
	exports.createRequest = function (e) {
	  ...
	  for (var id in localStorage) {
	    try {
	      ...
	      if (object.login() !== undefined && object.type() == 'Исполнитель') performersId.push(id);
	    } catch (err) {}
	  }
	...
	exports.recordRequest = function (e) {
	  ...
	  var deadline = new Date(functions.create_request.find('.years').prop('value'), functions.create_request.find('.months').prop('value'), functions.create_request.find('.days').prop('value'), functions.create_request.find('input[name="hours"]').prop('value'), functions.create_request.find('input[name="minutes"]').prop('value'), functions.create_request.find('input[name="seconds"]').prop('value')).toLocaleString('ru', exports.options);
	...
	exports.submitRequest = function (e) {
	  ...
	  if (exports.user.type() === 'Администратор') {
	    ...
	    var deadline = new Date(functions.edit_request.find('.years').prop('value'), functions.edit_request.find('.months').prop('value'), functions.edit_request.find('.days').prop('value'), functions.edit_request.find('input[name="hours"]').prop('value'), functions.edit_request.find('input[name="minutes"]').prop('value'), functions.edit_request.find('input[name="seconds"]').prop('value')).toLocaleString('ru', exports.options);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(_) {var exports = module.exports = {};
